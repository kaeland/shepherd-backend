...
audrey = User.create(first_name: 'Audrey', last_name: 'Dortch')
gabe = User.create(first_name: 'Gabe', last_name: 'Murphy')
jameson = User.create(first_name: 'Jameson', last_name: 'Murphy')
chris = User.create(first_name: 'Chris', last_name: 'Brown')
tom = User.create(first_name: 'Tom', last_name: 'Davis')
sarah = User.create(first_name: 'Sarah', last_name: 'Johnson')
